/* PrismJS 1.15.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+bash+docker+markup-templating+git+less+http+json+nginx+php+php-extras+sql+jsx+typescript+sass+pug+tsx&plugins=line-numbers+autolinker+toolbar+normalize-whitespace+show-language */
