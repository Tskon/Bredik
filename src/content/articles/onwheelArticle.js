    ...
    return (
      <article>
        ...
        <section>
          ...
          Проверяем - теперь можно колесиком листать слайды.
          Однако при тестировании на ноутбуке получаем неожиданный результат - даже при небольшом пролистывании в
          лучшем случае пролистывается несколько слайдов, а то и до самого конца. Проблема заключается в том, что
          тачпад для эмуляции плавного скроллинга делает много событий onWheel с совершенно разными значениями e.deltaY
          (от самых маленьких и до 200-300). Более того эти события продолжают гененрироваться в зависимости от резкости
