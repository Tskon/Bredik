    ...
    return (
      <article>
        ...
        <section>
          <h2>Ситуация</h2>
          <p>
            На проекте страничка-лэндинг оформлена слайдером, т.е каждый экран лэндинга - слайд листащийся вертикально.
        ...
        <section>
          ...
          <p>
            ...
            лучшем случае пролистывается несколько слайдов, а обычно до конца страницы сразу. Проблема заключается в
            том,
          ...
          <p>
            На ум приходит решение через короткий таймаут после каждой итерации события onWheel, т.к. тачпады их
            генерируют почти беспрерывно.
